(function(exports) {
  ...
  _KEY_PROP.ENTER = {};
  _KEY_PROP.ENTER.key =
  _KEY_PROP.ENTER.code =
  _KEY_PROP.ENTER.keyIdentifier = 'Enter';
  _KEY_PROP.ENTER.which =
  _KEY_PROP.ENTER.keyCode = 13;

  _KEY_PROP.ENTER = {};
  _KEY_PROP.ENTER.key =
  _KEY_PROP.ENTER.code =
  _KEY_PROP.ENTER.keyIdentifier = 'Esc';
  _KEY_PROP.ENTER.which =
  _KEY_PROP.ENTER.keyCode = 27;
